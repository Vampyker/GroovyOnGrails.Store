<html>
  ...
  <body>
    <h2>Add Product</h2>
    <g:form  class="value" action="${params.action}">
    <table>
      <tr>
        <td>
            <div class="label"> 
        ...
        <td>
            <div>
                <input class="value" type='text' name="title" value="${params.title}" />
                <div class='errors'>
                    <g:renderErrors bean="${product}" as="list" field="title"/>
                </div>
            </div>
        </td>
      </tr>
        ...
        <td>
            <div class="value">
                <g:select name="category_id" from="${categories}" 
                    optionKey="id" optionValue="name" value="${params.category_id}" />
                <div class='errors'>
                    <g:renderErrors bean="${category}" as="list" field="title"/>
                </div>
            </div>
        </td>
      </tr>
